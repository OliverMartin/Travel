...
class appProdProjectContainer extends Container
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_20841ebce59e5aba284becc19839f95c02fb0e13a18d8ec02a66f1be89a40924');
        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_20841ebce59e5aba284becc19839f95c02fb0e13a18d8ec02a66f1be89a40924');
        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_20841ebce59e5aba284becc19839f95c02fb0e13a18d8ec02a66f1be89a40924');
        ...
        $d->setProxyDir('D:/SapiensSoftware/Vistatravel/home/app/cache/prod/doctrine/orm/Proxies');
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('D:/SapiensSoftware/Vistatravel/home/app/logs/prod.log', 100, true);
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('D:/SapiensSoftware/Vistatravel/home/app/cache/prod/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('D:/SapiensSoftware/Vistatravel/home/app/cache/prod/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'D:/SapiensSoftware/Vistatravel/home/app/../web', false);
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'D:/SapiensSoftware/Vistatravel/home/app/cache/prod');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => false,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'D:/SapiensSoftware/Vistatravel/home/app/cache/prod',
            ...
            'session.save_path' => 'D:/SapiensSoftware/Vistatravel/home/app/cache/prod/sessions',
            ...
            'router.resource' => 'D:/SapiensSoftware/Vistatravel/home/app/config/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'D:/SapiensSoftware/Vistatravel/home/app/cache/prod/twig',
                'charset' => 'UTF-8',
                'paths' => array(
                ),
            ),
            ...
            'swiftmailer.spool.default.memory.path' => 'D:/SapiensSoftware/Vistatravel/home/app/cache/prod/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'D:/SapiensSoftware/Vistatravel/home/app/cache/prod/assetic',
            ...
            'doctrine.orm.proxy_dir' => 'D:/SapiensSoftware/Vistatravel/home/app/cache/prod/doctrine/orm/Proxies',
